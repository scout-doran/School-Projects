...
public class LabManagerView extends CenterFrame
{
   private void processGrade()
   {
      ...
      char grade = ((String) cboGrades.getSelectedItem()).charAt(0);
      sections.setGrade(sectionID, studentID, labID, grade);  //sets both student and partner grade (if applicable)

...
public class BlackJackPlayer
{
   ...
   public void split(Card card1, Card card2)
   {
      ...
      if (can_split)
      {
         ...
         hands.remove(index - 1);   //remove the old hand
         hands.add(index - 1, split[0]); //inserting new hands in the middle of the list
         hands.add(index - 1, split[1]);
      }
   }
   ...
   public void doubleDown(Card dealt)
   {
	  ...
	  //DO THIS
      hand.doubleDown();  //can't double this hand again
   }

...
{   
   ...
   //need another name for this method
   ...
   //recursive getHeight and isBalanced can be rewritten into a single method
   //with an int return type where -1 indicates not balanced

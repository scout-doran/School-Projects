...
public class SimpleDialogs
{
    ...
    *  Throws: None. <br>
    */
   public static void imageOutput(String message, String title, ImageIcon img)
   {
    ...
    *  Throws: None. <br>
    */
   public static String comboInput(String message, String title, ImageIcon img, String[] choices)
   {
      String temp="";
